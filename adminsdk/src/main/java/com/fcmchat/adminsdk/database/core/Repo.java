...
import com.fcmchat.adminsdk.database.DatabaseException;
import com.fcmchat.adminsdk.database.DatabaseReference;
import com.fcmchat.adminsdk.database.FirebaseDatabase;
import com.fcmchat.adminsdk.database.InternalHelpers;
import com.fcmchat.adminsdk.database.MutableData;
import com.fcmchat.adminsdk.database.Transaction;
import com.fcmchat.adminsdk.database.ValueEventListener;
import com.fcmchat.adminsdk.database.annotations.NotNull;
import com.fcmchat.adminsdk.database.connection.HostInfo;
import com.fcmchat.adminsdk.database.connection.ListenHashProvider;
import com.fcmchat.adminsdk.database.connection.PersistentConnection;
import com.fcmchat.adminsdk.database.connection.RequestResultCallback;
import com.fcmchat.adminsdk.database.core.persistence.NoopPersistenceManager;
import com.fcmchat.adminsdk.database.core.persistence.PersistenceManager;
import com.fcmchat.adminsdk.database.core.utilities.Tree;
import com.fcmchat.adminsdk.database.core.view.Event;
import com.fcmchat.adminsdk.database.core.view.EventRaiser;
...
import com.fcmchat.adminsdk.database.snapshot.NodeUtilities;
import com.fcmchat.adminsdk.database.snapshot.RangeMerge;
import com.fcmchat.adminsdk.database.utilities.DefaultClock;
import com.fcmchat.adminsdk.database.utilities.OffsetClock;
...
public class Repo implements PersistentConnection.Delegate {
  ...
  public void onRangeMergeUpdate(
      ...
      List<com.fcmchat.adminsdk.database.connection.RangeMerge> merges,
      Long tagNumber) {
    Path path = new Path(pathSegments);
    logger.debug("onRangeMergeUpdate: {} {}", path, merges);

    List<RangeMerge> parsedMerges = new ArrayList<>(merges.size());
    for (com.fcmchat.adminsdk.database.connection.RangeMerge merge : merges) {
