...
import static com.fcmchat.adminsdk.database.utilities.Utilities.hardAssert;

import com.fcmchat.adminsdk.database.DatabaseError;
import com.fcmchat.adminsdk.database.annotations.NotNull;
import com.fcmchat.adminsdk.database.annotations.Nullable;
import com.fcmchat.adminsdk.database.collection.LLRBNode;
import com.fcmchat.adminsdk.database.connection.ListenHashProvider;
import com.fcmchat.adminsdk.database.core.operation.AckUserWrite;
import com.fcmchat.adminsdk.database.core.operation.ListenComplete;
import com.fcmchat.adminsdk.database.core.operation.Merge;
import com.fcmchat.adminsdk.database.core.operation.Operation;
import com.fcmchat.adminsdk.database.core.operation.OperationSource;
import com.fcmchat.adminsdk.database.core.operation.Overwrite;
import com.fcmchat.adminsdk.database.core.persistence.PersistenceManager;
import com.fcmchat.adminsdk.database.core.utilities.ImmutableTree;
import com.fcmchat.adminsdk.database.core.view.CacheNode;
...
import com.fcmchat.adminsdk.database.core.view.View;
import com.fcmchat.adminsdk.database.snapshot.ChildKey;
import com.fcmchat.adminsdk.database.snapshot.CompoundHash;
import com.fcmchat.adminsdk.database.snapshot.EmptyNode;
import com.fcmchat.adminsdk.database.snapshot.IndexedNode;
import com.fcmchat.adminsdk.database.snapshot.NamedNode;
import com.fcmchat.adminsdk.database.snapshot.Node;
import com.fcmchat.adminsdk.database.snapshot.RangeMerge;
import com.fcmchat.adminsdk.database.utilities.Clock;
import com.fcmchat.adminsdk.database.utilities.NodeSizeEstimator;
import com.fcmchat.adminsdk.database.utilities.Pair;
...
public class SyncTree {
  ...
  private class ListenContainer implements ListenHashProvider, CompletionListener {
    ...
    @Override
    public com.fcmchat.adminsdk.database.connection.CompoundHash getCompoundHash() {
      ...
      return new com.fcmchat.adminsdk.database.connection.CompoundHash(posts, hash.getHashes());
    }
