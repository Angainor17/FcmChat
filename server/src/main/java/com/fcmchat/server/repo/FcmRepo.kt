...
import com.fcmchat.adminsdk.iid.FirebaseInstanceId
...
class FcmRepo(context: Context) : IFcmRepo {
    ...
    private val fcmServer: FcmServer = ServerInjector.createServer()
    ...
    override fun getTransactions(): Flowable<ArrayList<TransactionEntity>> {
